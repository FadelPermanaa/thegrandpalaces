# 🥂 Undangan Digital — Art Deco Gold Luxury Wedding
...
**Ciri khas tema Art Deco Gold:** cursor berbentuk belah ketupat (rotated square),
cover dengan sunburst & skyline kota bergaya Gatsby, geometri emas pada frame foto,
flip clock dengan aksen gradasi emas, dan closing dengan langit kota East Egg. Palet
hitam–champagne–emas.
...
```js
var WEDDING = new Date("2027-09-09T09:00:00+07:00");
var GROOM = "Ethan Alexander", BRIDE = "Vivienne Charlotte";
var BANK_NO = "9988 7766 5544";
```
Detail teks panjang (nama orang tua, alamat venue, isi FAQ, dsb.) mudah dicari lewat
komentar section seperti `THE EXTRANGAZA`, `LIEU`, `WEDDING GIFT`, `CONTACT`.
...
Selamat berbahagia di malam keemasan Anda. 🥂
