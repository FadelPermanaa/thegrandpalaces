# Celestial Observatory — Undangan Pernikahan Digital
...
Karena menggunakan `fetch`-style path absolut (`/assets/...`), jalankan lewat local server, bukan dibuka langsung sebagai file:
